...
var OrganizationsRoutingModule = (function () {
    ...
    OrganizationsRoutingModule = __decorate([
        core_1.NgModule({
            imports: [
                router_1.RouterModule.forChild(organizationsRoutes)
            ],
            exports: [
...
exports.OrganizationsRoutingModule = OrganizationsRoutingModule;
//# sourceMappingURL=organizations-routing.module.js.map